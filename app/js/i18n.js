...
const TRANSLATIONS = {
	es: {
		...
		"controls.period.hint":
			"Seleccione el período horario para mostrar en el mapa",
		"controls.day.label": "Día de predicción:",
		"controls.day.slider.aria":
			"Seleccionar día de predicción (1–14 días desde hoy)",
		"error.message":
			"<strong>Error:</strong> No se pudieron cargar los datos de predicción. Por favor, inténtelo de nuevo más tarde.",
		"loading.aria": "Cargando datos…",
		"loading.text": "Cargando predicciones…",
		"map.heading": "Mapa de Estaciones",
		"map.aria":
			"Mapa interactivo de estaciones de ruido de Madrid. Haga clic en un marcador para ver la predicción detallada de esa estación.",
		"legend.title": "Nivel LAeq (dB)",
		"legend.low": "< 55 dB — Bajo",
		"legend.mid": "55–65 dB — Moderado",
		"legend.high": "≥ 65 dB — Alto",
		"legend.note":
			"Umbrales basados en las directrices de la OMS para ruido ambiental (2018).",
		"popup.date": "Fecha",
		"popup.period": "Período",
		"popup.daytime": "Diurno (07–19 h)",
		...
		"chart.hint":
			"Haga clic en un marcador del mapa para ver la predicción de 14 días.",
		"chart.aria":
			"Gráfico de líneas con la predicción de ruido a 14 días para la estación seleccionada",
		...
		"cluster.n": "Clúster",
		"cluster.info.aria": "Más información sobre el clúster",
		"cluster.info.tooltip":
			"Según el análisis histórico, esta estación fue agrupada con aquellas que comparten un perfil de ruido similar.",
		"table.heading": "Estaciones — Predicción de Ruido",
		"table.scroll.aria": "Tabla de estaciones con ruido predicho",
		"table.caption":
			"Estaciones ordenadas por nivel de ruido LAeq predicho el día seleccionado",
		...
		"footer.data":
			'Datos de ruido: <a href="https://datos.madrid.es" target="_blank" rel="noopener noreferrer">Portal de Datos Abiertos del Ayuntamiento de Madrid</a>. Predicciones generadas mediante modelos de aprendizaje automático y suavizados clásicos.',
	...
	en: {
		...
		"error.message":
			"<strong>Error:</strong> Could not load forecast data. Please try again later.",
		"loading.aria": "Loading data…",
		"loading.text": "Loading forecasts…",
		"map.heading": "Station Map",
		"map.aria":
			"Interactive map of Madrid noise monitoring stations. Click a marker to see the detailed forecast for that station.",
		"legend.title": "LAeq Level (dB)",
		"legend.low": "< 55 dB — Low",
		"legend.mid": "55–65 dB — Moderate",
		"legend.high": "≥ 65 dB — High",
		"legend.note":
			"Thresholds based on WHO Environmental Noise Guidelines (2018).",
		"popup.date": "Date",
		"popup.period": "Period",
		"popup.daytime": "Daytime (07–19 h)",
		...
		"chart.aria":
			"Line chart with 14-day noise forecast for the selected station",
		...
		"cluster.n": "Cluster",
		"cluster.info.aria": "More information about the cluster",
		"cluster.info.tooltip":
			"Based on historical analysis, this station was grouped with others that share a similar noise profile.",
		"table.heading": "Stations — Noise Forecast",
		"table.scroll.aria": "Table of stations with predicted noise levels",
		"table.caption":
			"Stations sorted by predicted LAeq noise level for the selected day",
		...
		"footer.data":
			'Noise data: <a href="https://datos.madrid.es" target="_blank" rel="noopener noreferrer">Madrid Open Data Portal</a>. Forecasts generated using machine learning models and classical smoothing methods.',
