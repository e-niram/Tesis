...
const TRANSLATIONS = {
  es: {
    ...
    'cluster.info.tooltip':       'Según el análisis histórico, esta estación fue agrupada con aquellas que comparten un perfil de ruido similar.',
  ...
  en: {
    ...
    'cluster.info.tooltip':       'Based on historical analysis, this station was grouped with others that share a similar noise profile.',
